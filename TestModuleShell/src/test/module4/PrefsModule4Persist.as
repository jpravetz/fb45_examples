package test.module4
{
	 ...
	 */
	[Bindable]
	public class PrefsModule4Persist extends PrefsSharedObject
	{
		/**
		...
		private static const _log:Logger = LogContext.getLogger(PrefsModule4Persist);
		
		public function PrefsModule4Persist() {
